...
@php
$total_incomes = ($total_incomes_products + $total_incomes_bar + $total_incomes_fees);
$total_expenses = ($total_expenses_other + $total_expenses_products + $total_expenses_bar);
		...
		<div class="row">
			<div class="col-md-4">
				...
				<table class="table table-hover table-striped resumeFont">
					...
					<tr>
						<td>{{ __('app.Fees') }}</td>
						<td class="text-right">{{ number_format($total_incomes_fees, 2, ',', '.') }} {{  __('app.Coin') }}</td>
					</tr>
			...
			<div class="col-md-4">
				...
				<table class="table table-hover table-striped resumeFont">
					...
					<tr>
						<td>{{ __('app.Bar') }}</td>
						<td class="text-right">{{ number_format($total_expenses_bar, 2, ',', '.') }} {{  __('app.Coin') }}</td>
					</tr>				
					<tr>
