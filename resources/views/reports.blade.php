	...
	<div class="row">
		...
		<div class="col-md-6">
			...
			<div class="row">
	            <div class="col-md-12">
	                <div class="form-group">
						<button type="button" id="stats-refresh" data-url="{{ route('reports', ['type' => $type]) }}" class="btn btn-warning btn-lg"><i class="fa fa-sync text-white"></i> {{ __('general.Statistics_refresh') }}
	                </div>
            	</div>
	        </div>
	    </div>
